...
<body>
  ...
  <div class="left-sidebar-pro">
    ...
    <div class="all-content-wrapper">
        ...
        <center><div class="alert-area mg-b-15">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="alert-wrap1 shadow-inner wrap-alert-b">
                                <div class="alert-title">
                                    <br>
                                    <br>
                                    <center><marquee><h1>Welcome to ERP Portal of Indian Institute of Information Technology Kota</h1></marquee></center> <br>
                                    <img width="50%" src="img/logoIIITKOTA.png"> <br> <br> <br> <br> <br> <br> <br> <br>
                                    <p>To view your profile: <u><a href="profile.html">click here</a></u></p>
                                    <p>To go to IIITK's website <u><a href="http://www.iiitkota.ac.in">click here</a></u></p>
                                    <p>To contact support staff: <u><a href="contact.html">click here</a></u></p>
                                    <p>Mail us at <u><a href="mailto:'2018kucp1096@iiitkota.ac.in'">erpiiitkota@iiitkota.ac.in</a></u></p>
                                    ...
                                    <br>
                                    <br>
                                    <marquee>Note: To check for committee meeting's schedule, contact DUGC Convener</marquee>
                                </div>
                            </div>
                        </div>
                    </div>
