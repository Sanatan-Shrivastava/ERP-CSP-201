                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li id="removable">
                            ...
                            <ul class="submenu-angle page-mini-nb-dp" aria-expanded="false">
                                ...
                                <li><a title="500 Page" href="500.html"><span class="mini-sub-pro">Payment
                                            Receipt</span></a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                <img alt="logo" class="img-circle m-b" style="width: 45%;" src="img/contact/amit.jpeg">
                                <h3><a href="http://www.iiitkota.ac.in/amit"><?php echo $data['Name']; ?></a></h3>
                                <p class="all-pro-ad">Assistant Professor</p>
                                <p>
                                    <?php echo $data['Branch']; ?> <br>
                                    <strong>Email: </strong><a
                                        href="mailto:amit@iiitkota.ac.in"><?php echo $data['Contact']; ?></a> <br>
                                    <strong>Contact:</strong><a
                                        href="tel: +91-9549655278"><?php echo $data['Email']; ?></a>
                                </p>
                            </div>
